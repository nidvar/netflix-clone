...
import { clearHistory, getSearchHistory, removeFromHistory, searchMovie, searchPerson, searchPersonById, searchTVShow } from '../controllers/search.controller.js';
...
searchRouter.get('/personbyid/:id', searchPersonById);
